const API_URL = "https://cobv60onc5.execute-api.us-east-1.amazonaws.com/dev";
const PHOTOGALLERY_S3_BUCKET_URL = "photobucket-kim-e-2021-4150";
...
function loadViewPhotoPage(){
    ...
    $.ajax({
        ...
        success: function(data) {            
            console.log(data);
            photo=data.body[0];
            htmlstr = htmlstr + '<img class=\"img-responsive\" src=\"'+photo.URL+'\" alt=\"\"> <div class=\"blog-grid-content\"> <h2 class=\"blog-grid-title-lg\"><a class=\"blog-grid-title-link\" href=\"#\">'+photo.Title+'</a></h2> <p>By: '+photo.Username+'</p> <p>Uploaded: '+photo.CreationTime+'</p> <p>'+photo.Description+'</p> <h2 class=\"blog-grid-title-md\"><a class=\"blog-grid-title-link\" href=\"editphoto.html?id='+PhotoID+'\">'+"Edit Photo"+'</a></h2> <p> <h2 class=\"blog-grid-title-md\"><a class=\"blog-grid-title-link\" href=\"deletephoto.html?id='+PhotoID+'\">'+"Delete Photo"+'</a></h2></p> </div>'
...
function loadEditPhotoPage(){
    ...
    $.ajax({
        ...
        success: function(data) {            
            ...
            $('#editphoto-container').html(htmlstr);
        },
        error: function() {
            console.log("Failed");
        }
